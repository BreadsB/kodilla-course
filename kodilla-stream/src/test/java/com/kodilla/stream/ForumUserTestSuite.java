...
public class ForumUserTestSuite {
    ...
    @Mock
    private static ForumUser mockUser;
    ...
    void testGetLocationsOfFriendsOfFriends() {
        ...
        Assertions.assertEquals(3, user1.getLocationsOfFriendOfFriend().size());
        Assertions.assertTrue(user1.getLocationsOfFriendOfFriend().contains("Miami"));
        Assertions.assertTrue(user1.getLocationsOfFriendOfFriend().contains("Washington"));
        Assertions.assertTrue(user1.getLocationsOfFriendOfFriend().contains("Key West"));
